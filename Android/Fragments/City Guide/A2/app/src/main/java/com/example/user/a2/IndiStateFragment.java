...
public class IndiStateFragment extends ListFragment {

    //Obtain the reference of the listener
    private ListSelectionListener indiListener =null;
    ...
    public  void onListItemClick(ListView l,View v,int pos,long id)
    {
        ...
        indiListener.onListItemSelected(pos);
    }
    ...
    public void onAttach(Activity activity)
    {
        ...
        indiListener =(ListSelectionListener)activity;
    }
    ...
    public  void onActivityCreated(Bundle savedInstance)
    {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(),R.layout.indi_state_layout,getResources().getStringArray(R.array.IndiPlaces)));
    }
